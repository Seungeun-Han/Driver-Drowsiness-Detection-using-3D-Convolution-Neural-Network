...
if __name__ == '__main__':
    ...
    #####################################데이터셋 경로(필요시 수정)###########################################
    dir_name = "./NTHU-DDD/Training_Evaluation_Dataset/Training_Dataset/"
    save_dir = "./NTHU-DDD-gc/Training_Evaluation_Dataset/Training_Dataset/"
    #####################################데이터셋 경로(필요시 수정)###########################################

    subject_list = os.listdir(dir_name)
    scenario_list = ["nonsleepyCombination", "sleepyCombination", "slowBlinkWithNodding", "yawning"]
    extension = ".avi"
    txt_list = ['_nonsleepyCombination_drowsiness.txt', '_sleepyCombination_drowsiness.txt',
                '_slowBlinkWithNodding_drowsiness.txt', '_yawning_drowsiness.txt']
    ...
    for subject in subject_list:
        ...
        for condition in condition_list:
            for index, scenario in enumerate(scenario_list):
                ...
                label = open(dir_name + subject + "/" + condition + "/" + subject + txt_list[index], 'r')
                label = list(label)
                        ...
                        for b in dets:
                            ...
                            if args.save_image:
                                ...
                                """if not os.path.exists(
                                        save_dir + subject + "/" + condition + "/" + scenario + "/" + "left_eye/"):
                                    os.makedirs(save_dir + subject + "/" + condition + "/" + scenario + "/" + "left_eye/")
                                left_eye_path = save_dir + subject + "/" + condition + "/" + scenario + "/" + "left_eye/" + str(
                                    frame_num) + ".jpg" """

                                if not os.path.exists(
                                        save_dir + subject + "/" + condition + "/" + scenario + "/" + "right_eye/"):
                                    os.makedirs(save_dir + subject + "/" + condition + "/" + scenario + "/" + "right_eye/")
                                right_eye_path = save_dir + subject + "/" + condition + "/" + scenario + "/" + "right_eye/" + str(
                                    frame_num) + ".jpg"

                                if not os.path.exists(
                                        save_dir + subject + "/" + condition + "/" + scenario + "/" + "mouth/"):
                                    os.makedirs(save_dir + subject + "/" + condition + "/" + scenario + "/" + "mouth/")
                                mouth_path = save_dir + subject + "/" + condition + "/" + scenario + "/" + "mouth/" + str(
                                    frame_num) + ".jpg"
                ...
                print(txt)
                np.savetxt(save_dir + subject + "/" + condition + "/" + subject + txt_list[index], txt, fmt='%d', delimiter='', newline='')
                cap.release()
